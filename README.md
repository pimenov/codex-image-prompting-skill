...
Для обычных заголовков и коротких подписей skill сначала пробует текст прямо в
ImageGen. Длинные URL, юридически точные строки, credits и мелкие footer-надписи
считаются production/post-production задачей, если их нужно получить
пиксельно-точно.
